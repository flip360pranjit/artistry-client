  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-7">
      <button
        ...
        className={`flex w-full items-center justify-center bg-white gap-3 rounded-md px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm border border-gray-300 ${
